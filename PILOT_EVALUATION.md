...
- Phương án A: AI hỏi đáp phổ thông với tài liệu và thời hạn cố định. Phương án B: PatentLens v25. Phương án C: chuyên gia sử dụng quy trình hiện có nếu được cho phép. Ghi rõ nguồn dữ liệu và công cụ mỗi phương án được tiếp cận, số lần chạy, chi phí/giới hạn.
...
## Chỉ số riêng cho v25 (CHƯA CÓ SỐ LIỆU)

| Case | Lượt AI gợi ý Không tìm thấy | Lượt được hạ Chưa chắc chắn | Lượt chuyên gia xác nhận khảo sát, ghi đủ phạm vi | Gợi ý động cơ trích hợp lệ trong văn bản đã gửi | Gợi ý sai ngữ cảnh sau chuyên gia kiểm | Thời gian chuyên gia tại Bước 6/7 (phút) |
|---|---|---|---|---|---|---|
| CHƯA THỰC HIỆN | — | — | — | — | — | — |

**Không suy** “AI hạ xuống Chưa chắc chắn” = “ảo giác”: đó có thể chỉ là thiếu dữ liệu hoặc thiếu căn cứ. Để đếm hallucination, cần giữ bản dự đoán thô, tài liệu gốc và chuyên gia xác định nguyên nhân. Nếu không có quyền giữ hoặc chia sẻ dữ liệu đó, báo cáo rõ không đo được.
